...
class SettingsGrid(QWidget):
    ...
    def update_settings(self, settings: dict, shared_with: list = None):
        ...
        # Update dropdown in main window with categories
        ...
        for index, category in enumerate(sorted(categorized_params.keys())):
            ...
            if row > 0:
                ...
                self.grid_layout.addWidget(separator, row, 0, 1, 2)
                row += 1
            ...
            category_layout.setSpacing(10) # Add some horizontal spacing between columns
            ...
            for param_name, value in sorted_params:
                ...
                if 'notes' in param_def:
                    ...
                    notes_label.setFixedWidth(300)  # Match header width
                    category_layout.addWidget(notes_label, param_row, 2)  # Add to third column
            ...
            self.grid_layout.addWidget(category_container, row, 0, 1, 2)
            row += 1                
